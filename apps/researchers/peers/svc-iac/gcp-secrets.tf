...
locals {
  database_direct_url = "${data.cockroach_connection_string.db.connection_string}&sslrootcert=$HOME/.postgresql/root.crt&options=--${var.project_id}"
  database_pooler_url = "${data.cockroach_connection_string.db.connection_string}&sslrootcert=$HOME/.postgresql/root.crt&options=--${var.project_id}"
}
